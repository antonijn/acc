...
\subsection{Problem}
The original i386 processors had only very few general purpose registers
(\verb+eax+, \verb+ebx+, \verb+ecx+, \verb+edx+, \verb+esi+ and
\verb+edi+).\cite[section~3.4.1]{intel}

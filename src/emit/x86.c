...
static const struct asmreg rax = NEW_REG(8, "rax", NULL, &eax, NULL);
static const struct asmreg rbx = NEW_REG(8, "rbx", NULL, &ebx, NULL);
static const struct asmreg rcx = NEW_REG(8, "rcx", NULL, &ecx, NULL);
static const struct asmreg rdx = NEW_REG(8, "rdx", NULL, &edx, NULL);
static const struct asmreg rsp = NEW_REG(8, "rsp", NULL, &esp, NULL);
static const struct asmreg rbp = NEW_REG(8, "rbp", NULL, &ebp, NULL);
static const struct asmreg rsi = NEW_REG(8, "rsi", NULL, &esi, NULL);
static const struct asmreg rdi = NEW_REG(8, "rdi", NULL, &edi, NULL);
static const struct asmreg r8 = NEW_REG(8, "r8", NULL, &r8d, NULL);
static const struct asmreg r9 = NEW_REG(8, "r9", NULL, &r9d, NULL);
static const struct asmreg r10 = NEW_REG(8, "r10", NULL, &r10d, NULL);
static const struct asmreg r11 = NEW_REG(8, "r11", NULL, &r11d, NULL);
static const struct asmreg r12 = NEW_REG(8, "r12", NULL, &r12d, NULL);
static const struct asmreg r13 = NEW_REG(8, "r13", NULL, &r13d, NULL);
static const struct asmreg r14 = NEW_REG(8, "r14", NULL, &r14d, NULL);
static const struct asmreg r15 = NEW_REG(8, "r15", NULL, &r15d, NULL);
